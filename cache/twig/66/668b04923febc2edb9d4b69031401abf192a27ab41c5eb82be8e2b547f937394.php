...
class __TwigTemplate_73ddbb6040bd5b08f37d7f8fcec8b675c92e37e959895b7cabba6be508e7e061 extends \Twig\Template
{
...
/* HERO IMAGE: gelapkan gambar */
.hero img {
  width: 100%;
  height: auto;
  display: block;
  filter: brightness(0.5); /* gelapkan gambar */
  object-fit: cover;
}
...
.hero-content h1 {
  ...
  font-weight: 700;
  margin: 0 0 10px 0;
  text-shadow: 2px 2px 6px rgba(0,0,0,0.6); /* membuat teks tetap terbaca */
}
