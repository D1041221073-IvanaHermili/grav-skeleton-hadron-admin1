...
/* @Page:C:/xampp/htdocs/grav-skeleton-hadron-admin1/user/pages/02.profil/profil-2 */
class __TwigTemplate_21f13311c8dd25e5f6d09351473d08ea1260a3ef12c307d24ce5af5b340890e5 extends \Twig\Template
{
...
<div class=\"page-wrapper\">
  ...
  <div class=\"section-card\">
    ";
        ...
        ob_start();
        // line 205
        echo "![Profil-Pimpinan-Dinas-PMD-Kalbar](Profil-Pimpinan-Dinas-PMD-Kalbar-2023-3-pdf.jpg)
    ";
  ...
  <div class=\"lhkpn-grid\">
    ...
    <div class=\"lhkpn-card\">
      <div class=\"lhkpn-img-container\">
        ...
        ob_start();
        // line 218
        echo "![2023](2023-LHKPN-KADIS-2022_images-extracted-1-768x1081.jpg)
        ";
        $content = ob_get_clean();
        preg_match("/^\s*/", $content, $matches);
        $lines = explode("\n", $content);
    ...
    <div class=\"lhkpn-card\">
      <div class=\"lhkpn-img-container\">
        ...
        ob_start();
        // line 229
        echo "![2024](2024-LHKPN-HENDRA-BACHTIAR.jpeg)
        ";
        $content = ob_get_clean();
        preg_match("/^\s*/", $content, $matches);
        $lines = explode("\n", $content);
    ...
    <div class=\"lhkpn-card\">
      <div class=\"lhkpn-img-container\">
        ...
        ob_start();
        // line 240
        echo "![2025](2025-LHKPN-Hendra-Bachtiar.jpg)
        ";
        $content = ob_get_clean();
        preg_match("/^\s*/", $content, $matches);
        $lines = explode("\n", $content);
  ...
  <!-- DOKUMEN -->
  <div class=\"section-card\">
  <h2 id=\"dokumen-lhkpn-lhkasn\"><a href=\"#dokumen-lhkpn-lhkasn\" class=\"toc-anchor before\" data-anchor-icon=\"#\" aria-label=\"Anchor\"></a>Dokumen LHKPN &amp; LHKASN</h2>
  ...
  <div class=\"link-list\">
    ...
    {
        return "@Page:C:/xampp/htdocs/grav-skeleton-hadron-admin1/user/pages/02.profil/profil-2";
    }
    ...
    {
        return array (  311 => 242,  302 => 240,  300 => 239,  290 => 231,  281 => 229,  279 => 228,  269 => 220,  260 => 218,  258 => 217,  246 => 207,  237 => 205,  235 => 204,  30 => 1,);
    }
    ...
    {
        return new Source("", "@Page:C:/xampp/htdocs/grav-skeleton-hadron-admin1/user/pages/02.profil/profil-2", "");
    }
}
